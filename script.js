...
switch(finalWeatherCondition){
case "clouds":
background_image.style.backgroundImage="url(./Assets/Images/clouds.png)"
break;
}
...
switch(finalWeatherCondition){
    case "mist":
    background_image.style.backgroundImage="url(./Assets/Images/mist.png)"
    break;
    }
   ...
   //* For Haze Weather
    switch(finalWeatherCondition){
        case "haze":
        background_image.style.backgroundImage="url(./Assets/Images/haze.png)"
        break;
        }
   ...
   //* For Rainy Weather
    switch(finalWeatherCondition){
        case "rain":
        background_image.style.backgroundImage="url(./Assets/Images/rain.png)"
        break;
        }
   ...
   //*For Drizzle Weather
        switch(finalWeatherCondition){
            case "drizzle":
            background_image.style.backgroundImage="url(./Assets/Images/drizzle.png)"
            break;
            }
    ...
    switch(finalWeatherCondition){
        case "dust":
        background_image.style.backgroundImage="url(./Assets/Images/dust.png)"
        break;
        }

    //* For Thunder Storm Weather
    switch(finalWeatherCondition){
        case "thunderstorm":
        background_image.style.backgroundImage="url(./Assets/Images/thunderstorm.png)"
        break;
        }
        ...
        switch(finalWeatherCondition){
            case "snow":
            background_image.style.backgroundImage="url(./Assets/Images/snow.png)"
            break;
            }
